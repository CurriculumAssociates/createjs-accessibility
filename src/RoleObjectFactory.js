 ...
 * @param {Function} [config.onFocus] - Optional callback when the DisplayObject is
 * brought into focus
 * @param {Function} [config.onKeyboardClick] - Optional callback when the keyboard is clicked
 * while the DisplayObject is in focus
