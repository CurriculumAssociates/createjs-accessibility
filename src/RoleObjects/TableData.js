...
export default class TableData extends SectionData {
  addChild(displayObject) {
    if (!displayObject.accessible || [ROLES.TABLEBODY,
      ROLES.TABLEFOOT,
      ROLES.TABLEHEAD].indexOf(displayObject.accessible.role) === -1) {
   ...
   * -1 if the total number of rows is unknown and also indicates that the value
    should not be calculated by the user agent.
   * @access public
   ...
   * -1 if the total number of rows is unknown and also indicates that the
    value should not be calculated by the user agent.
   * @access public
   ...
   * -1 if the total number of columns is unknown and also indicates that
    the value should not be calculated by the user agent.
   * @access public
   * @param {Number} val - Positive number , -1 if its unknown.
   */
  set colcount(val) {
   ...
   * -1 if the total number of columns is unknown and also indicates that the
    value should not be calculated by the user agent.
   * @access public
   * @returns {Number} - Positive number , -1 if its unknown.
   */
