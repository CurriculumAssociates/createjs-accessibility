 ...
 */
export enum ROLES {
  // special role meaning that there is no particular ARIA role assigned
  // (e.g. a generic container, displayed text)
  NONE = 'none',
  ...
  // the aria role is just "heading" but to convert the role to a tag, the additional information
  // of which level is needed as well
  HEADING1 = 'heading1',
  HEADING2 = 'heading2',
  HEADING3 = 'heading3',
  HEADING4 = 'heading4',
