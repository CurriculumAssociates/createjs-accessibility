...
describe('Roles', () => {
  describe('doesRoleUseSemanticallyInteractiveTag', () => {
    it('returns true for interactive tags', () => {
      ...
      expect(doesRoleUseSemanticallyInteractiveTag('multiselectlistbox')).toEqual(true);
      ...
      expect(doesRoleUseSemanticallyInteractiveTag('multilinetextbox')).toEqual(true);
