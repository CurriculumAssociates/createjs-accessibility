...
export default class SectionData extends AccessibilityObject {
   ...
   * @access public
   * @param {boolean} val - true if the section is expanded, false
     if it is collapsed, undefined if the item is not expandable
   */
  set expanded(val) {
   ...
   * @access public
   * @returns {boolean} - true if the item is expanded, false if the item is
    collapsed, undefined if it is not expandable
   */
  get expanded() {
