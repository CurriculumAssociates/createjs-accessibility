...
export default class AccessibilityObject {
  constructor(displayObject, role, domIdPrefix) {
    ...
    /**
     * Fields with relatively fixed values that should go into the React props for
        the element translation of this object.  This is done as an object for easy
        merging with the rest of the props
     * @access private
     */
    this._reactProps = {
  ...
  /**
   * Adds the specified DisplayObject as a child of the DisplayObject associated with
      this AccessibilityObject in the accessibility tree.  The specified DisplayObject
      must have accessibility information already present.  Different subclasses
      may limit the valid roles for the specified DisplayObject.
   * todo: list role restrictions
   * @access public
   * @param {createjs.DisplayObject} displayObject - accessibility annotated
      DisplayObject to add as a child in the accessibility tree
   */
  ...
  /**
   * Adds the specified DisplayObject as a child of the DisplayObject
      associated with this AccessibilityObject in the accessibility
      tree at the specified index.  The specified DisplayObject must have
      accessibility information already present.  Different subclasses
      may limit the valid roles for the specified DisplayObject (see addChild's
      function comment for list of role restrictions).
   * @access public
   * @param {createjs.DisplayObject} displayObject - accessibility annotated
      DisplayObject to add as a child in the accessibility tree
   * @param {Number} index - 0 based index that the DisplayObject should have
      in the array of children once added
   */
  ...
  /**
   * Removes the child at the specified index of this AccessibilityObject from the
     accessibility tree.
   * @access public
   ...
   * @access public
   * @param {boolean} enable - true if the keydown/keyup events should be sent
     to the DisplayObject.  false otherwise.
   */
  ...
  /**
   * Retrieves whether keydown/keyup events are currently configured to be sent to
      the DisplayObject.
   * @access public
   * @returns {boolean} true if the keydown/keyup events should be sent to the
   ...
   * @access public
   * @param {String} keycode - string containing the letter to use for the
      keyboard shortcut
   */
  ...
  /**
   * Retrieves the keyboard shortcut to click the DisplayObjec
   * @access public
   ...
   * Sets the keyboard shortcut to click the DisplayObject
   * @access public
   * @param {String} str - "yes" or "no" Specifies that the content of the element
   ...
   * @access public
   * @param {String} title - string to convey extra information about the DisplayObjectp
   */
  set title(title) {
   ...
   * @access public
   * @returns {String} string to convey extra information about the DisplayObject
   */
  get title() {
   ...
   * @access public
   * @returns {String} lang: eg. "en" for English, "es" for Spanish, "fr" for French,
   and For all language codes, see https://www.w3schools.com/tags/ref_language_codes.asp".
   */
  get lang() {
   ...
   * The lang attribute specifies the language of the element's content.
   * @access public
   * @param {String} lang: eg. "en" for English, "es" for Spanish, "fr" for French,
   and For all language codes, see https://www.w3schools.com/tags/ref_language_codes.asp".
   */
  set lang(lang) {
   ...
   * @access public
   * @returns {boolean} true if ATs should present the region as a whole,
    false for parts, undefined if the field is unset.
   */
  get atomic() {
   ...
   * @access public
   * @param {boolean} updating - true if updating is in progress, false
    if there are no more expected updates, undefined to unset the field.
   */
  set busy(updating) {
   ...
   * @access public
   * @returns {boolean} true if updating is in progress, false if there are no
    more expected updates, undefined if the field is unset.
   */
  get busy() {
   ...
   * @access public
   * @param {createjs.DisplayObject} displayObject - DisplayObject controlled
    by this one.  undefined to unset the field.
   */
  ...
  /**
   * Retrieves the DOM id of the translated DisplayObject that has accessibility
    information describing this one.
   * @access public
  ...
  /**
   * Retrieves the value of the id attribute used in the DOM for the DisplayObject's
   ...
   * @access public
   * @param {boolean} dragging - true if being dragged, false for not being dragged
   but supports it, undefined for not being dragged and doesn't support it
   */
   ...
   * @access public
   * @returns {boolean} true if being dragged, false for not being dragged but
   ...
   * @access public
   * @param {boolean} popup - true if the DisplayObject has a popup, false otherwise.
    undefined to unset the field.
   */
  set hasPopUp(popup) {
   ...
   * @access public
   * @returns {boolean} true if the DisplayObject has a popup, false otherwise.
   ...
   * @param {createjs.DisplayObject} displayObject - DisplayObject that
    labels this one.  undefined if the field is to be cleared
   */
  ...
  /**
   * Retrieves the priority level of the user being informed of updates to the
    translated DOM element or its children
   * @access public
  ...
  /**
   * Sets which DisplayObjects that are not children in the accessibility tree but
     have a child relationship with this one
   * @access public
   * @param {Array<createjs.DisplayObject>} displayObjects - array of DisplayObjects
     that should have a child relationship without being children in the accessibility
     tree.  undefined if the field is to be cleared
   */
  ...
  /**
   * Retrieves which DisplayObjects that are not children in the accessibility tree
   but have a child relationship with this one
   * @access public
   * @returns {Array<createjs.DisplayObject>} array of DisplayObjects that should have a
    child relationship without being children inthe accessibility tree.undefined
  ...
  /**
   * Retrieves the AccessibilityObject that is this one's parent in an
    accessibility tree.  null if this is currently not in an accessibility tree.
   * @access public
   ...
   * Note: if this field is unset (undefined) and the DisplayObject's .visible
    field a falsey value, then the translated DOM entry will have 'display'
    set to 'none'.  If you want to prevent this automatic field determination,
    then this field should be set to true or false.
   * @access public
   * @param {boolean} vis - true if DOM translation should be displayed,
    false for hidden.  undefined to unset the field.
   */
  set visible(vis) {
    this._visible = vis;
  }
  ...
  /**
   * Retrieves whether the DisplayObject is displayed in the DOM translation,
    taking into account the automatic field determination done when translating
    to the DOM.
   * @access public
  ...
  /**
   * Makes the DOM entry visible immediately.  This does not affect the value
   used during the next render of the accessibility tree.
   * @package
   */
  _forceShow() {
