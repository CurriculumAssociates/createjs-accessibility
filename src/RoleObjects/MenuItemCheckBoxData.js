...
export default class MenuItemCheckBoxData extends MenuItemData {
   ...
   * @access public
   * @param {boolean} check - true if the element is checked, false if the element
    is unchecked, mixed if the element mixture of checked and unchecked values.
   */
  set checked(check) {
   ...
   * @access public
   * @returns {boolean}  - true if the element is checked, false if the element
   is unchecked, mixed if the element mixture of checked and unchecked values.
   */
  get checked() {
